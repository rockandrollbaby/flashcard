...
//Second Row
  ...
  $("#h3-parameters").click(function(){
    $("#p-parameters").fadeIn();
    $("#h3-parameters").hide();
  });

  $("#p-parameters").click(function(){
    $("#p-parameters").fadeOut();
    $("#h3-parameters").fadeIn();
  });
...
$("#h3-escape").click(function(){
  $("#p-escape").fadeIn();
  $("#h3-escape").hide();
});

$("#p-escape").click(function(){
  $("#p-escape").fadeOut();
  $("#h3-escape").fadeIn();
});

$("#h3-alert").click(function(){
  $("#p-alert").fadeIn();
  $("#h3-alert").hide();
});
...
$("#h3-jQuery").click(function(){
  $("#p-jQuery").fadeIn();
  $("#h3-jQuery").hide();
});

$("#p-jQuery").click(function(){
  $("#p-jQuery").fadeOut();
  $("#h3-jQuery").fadeIn();
});

$("#h3-attributes").click(function(){
  $("#p-attributes").fadeIn();
  $("#h3-attributes").hide();
});

$("#p-attributes").click(function(){
  $("#p-attributes").fadeOut();
  $("#h3-attributes").fadeIn();
});
